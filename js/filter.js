...
function filterMild() {
	...
	return $(":contains('Bernie'), :contains('BERNIE'), :contains('bernie'), :contains('Sanders'), :contains('SANDERS'), :contains('sanders')").filter("h1,h2,h3,h4,h5,p,span,li");
}

function filterDefault () {
	console.log("Filtering Bernie with Default filter...");
	return $(":contains('Bernie'), :contains('BERNIE'), :contains('bernie'), :contains('Sanders'), :contains('SANDERS'), :contains('sanders')").filter(":only-child").closest('div');
}

function filterVindictive() {
	console.log("Filtering Bernie with Vindictive filter...");
	return $(":contains('Bernie'), :contains('BERNIE'), :contains('bernie'), :contains('Sanders'), :contains('SANDERS'), :contains('sanders')").filter(":not('body'):not('html')");
}
